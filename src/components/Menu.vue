<template>
    <div class="menu">
      <a class="signup" @click.prevent="loginWG" v-if="!this.$gAuth.isAuthorized">
      ...
      <a v-if="this.$gAuth.isAuthorized" @click.prevent="logout" class="signout"> Desconectar </a>
    </div>
</template>
